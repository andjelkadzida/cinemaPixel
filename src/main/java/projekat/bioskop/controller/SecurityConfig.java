...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http
                .authorizeRequests()
                .antMatchers("/pocetna", "/error", "/pregledFilmova/**", "/pregledProjekcija/**", "/pregledBioskopa/**", "/static/**", "/images/**", "/usloviKoriscenja/**", "/politikaPrivatnosti/**", "/oNama/**", "/favicon.ico").permitAll()
